		...
		<div class="form_pad">
			...
			>
				<a-form-item label="收费类型">
					<a-radio value="1">行程费用</a-radio>
					<a-radio value="2">企业费用</a-radio>
				</a-form-item>
				...
				<a-form-item label="团单类型">
					...
					<a-radio value="2">休闲团</a-radio>
					<a-radio value="3">散拼团</a-radio>
				</a-form-item>
				<a-form-item label="是否必收费用">
					<a-radio value="1">必收</a-radio>
					<a-radio value="2">可选</a-radio>
				</a-form-item>
				<a-form-item label="说明" name="name">
			...
			<div style="height: 300px">
				<CommonTable :dataSource="formState.list" :columns="columns"> </CommonTable>
			</div>
		</div>
	</div>
	<div class="footer">
