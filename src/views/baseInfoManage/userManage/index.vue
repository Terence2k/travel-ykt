...
<script setup lang="ts">
  ...
  onBeforeMount(() => {
    ...
    !['PLATFORM_SUPER_ADMIN', 'GROUP_SUPER_ADMIN', 'CULTURE_BUREAU_CERTIFICATE_HANDLING', 'ASSOCIATION_SUPER_ADMIN', 'SUPERVISE_SUPER_ADMIN', 'ANCIENT_UYGUR_SUPER_ADMIN'].includes(item.roleCode));
    // 集团超级管理员不显示操作
