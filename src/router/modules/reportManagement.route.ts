export default [
	{
		...
		children: [
			...
			// },
			{
				path: 'standardGroupReport',
				name: 'standardGroupReport',
				redirect: '/reportManagement/standardGroupReport/list',
				meta: {
					title: '标准团结算报表',
					isDetail: true, // 在左侧的导航栏不会展示
				},
				children: [
					{
						path: 'list',
						component: () => import('@/views/reportManagement/standardGroupReport/index.vue'),
						name: 'standardGroupReportList',
						meta: {
							title: '首页',
							isDetail: true, // 在左侧的导航栏不会展示
						},
			...
			{
				path: 'individualGroupReport',
				name: 'individualGroupReport',
				redirect: '/reportManagement/individualGroupReport/list',
				meta: {
					title: '散客团结算报表',
					isDetail: true, // 在左侧的导航栏不会展示
				},
				children: [
					{
						path: 'list',
						component: () => import('@/views/reportManagement/individualGroupReport/index.vue'),
						name: 'individualGroupReportList',
						meta: {
							title: '首页',
							isDetail: true, // 在左侧的导航栏不会展示
						},
